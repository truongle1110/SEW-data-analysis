...
GENOME_LENGTH = 38                                                      # number of possible group
POPULATION_SIZE = 60
GENERATIONS = 10000
p_c_min = 0.6
p_c_max = 0.9
...
# genome = [38, 31, 31, 31, 37, 32, 32, 30, 30, 21, 21, 21, 28, 10, 10, 10, 10, 19, 18, 18, 8, 8, 8, 9, 9, 14, 13, 4, 25, 25, 2, 2, 7, 7, 3, 1, 20, 20]     #fitness: 7094.217527802756
        #  = [38, 9, 9, 9, 9, 29, 29, 10, 10, 36, 36, 36, 33, 6, 6, 6, 25, 25, 22, 22, 35, 35, 35, 35, 23, 17, 16, 12, 37, 37, 27, 27, 27, 27, 8, 5, 3, 3]    #fitness = 6205.3172222011435
N, G_activity = decode(genome)
